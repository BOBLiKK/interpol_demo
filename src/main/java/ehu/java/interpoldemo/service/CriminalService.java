...
public interface CriminalService {
    boolean addCriminal(String name, String surname, LocalDate dateOfBirth, String citizenship, String description, double reward, byte[] image) throws ServiceException;
